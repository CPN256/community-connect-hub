import { Shield, Siren, Flame, BadgeAlert, Heart, Zap, Phone, Building2 } from "lucide-react";

const emergencyContacts = [
  { name: "Uganda Police", number: "999", icon: Shield, color: "text-primary", desc: "Report crimes, theft, assault" },
  { name: "Ambulance / EMRS", number: "911", icon: Siren, color: "text-destructive", desc: "Medical emergencies" },
